...
_ALLOWED_ACTIONS: dict[WorkflowStatus, list[str]] = {
    ...
    WorkflowStatus.REPAIR_PROPOSED: ["propose_change", "select_repair_option"],
    WorkflowStatus.AWAITING_REPAIR_AUTHORIZATION: [
        "propose_change",
        "authorize_repair_budget",
    ],
    WorkflowStatus.ASSEMBLING: ["view_assembly_progress"],
    WorkflowStatus.FINAL_REVIEW: ["propose_change", "export_accepted_production"],
    WorkflowStatus.COMPLETED: [
        "propose_change",
        "download_delivery",
        "open_professional_mode",
    ],
