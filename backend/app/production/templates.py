"""Provider-neutral graph templates for the canonical production workbench."""
...
def dialogue_post_dub_definition(
    *,
    ...
    """Build the provider-neutral graph for one dialogue shot."""
    ...
    nodes = [
        *[
        ...
        _node("voice", "voice", "Dialogue voice"),
...
__all__ = ["DIALOGUE_POST_DUB_SHOT_V1", "QUALITY_POLICY_V1", "dialogue_post_dub_definition"]
