...
export const DIRECTOR_STAGES: DirectorStageDefinition[] = [
  ...
  { id: "trial", number: 3, title: "代表镜头试拍", confirmation: "代表镜头与真实效果" },
  { id: "production", number: 4, title: "正式生产与交付", confirmation: "正式生产、局部修复和成片" },
];
...
export const WORKFLOW_STATUS_ZH: Record<DirectorWorkflowStatus, string> = {
  ...
  awaiting_trial_authorization: "等待试拍确认",
  ...
  awaiting_repair_authorization: "等待修复确认",
  assembling: "正在组装交付物",
  final_review: "等待逐镜验收",
  completed: "作品已完成",
  needs_human: "需要你查看证据",
...
export const NEXT_ACTION_ZH: Record<DirectorWorkflowStatus, string> = {
  ...
  drafting_shooting_plan: "让 AI 导演把已确认剧本整理成人物、声音、分镜、风险和模型方案。",
  awaiting_shooting_confirmation: "查看人物、分镜、风险和推荐模型，确认是否值得进入试拍。",
  awaiting_trial_authorization: "查看代表镜头、模型能力和风险，然后确认试拍。",
  trial_running: "代表镜头正在生成；完成前不会自动扩大生产范围。",
  awaiting_trial_review: "查看真实试拍与质量证据，决定修复还是继续。",
  awaiting_production_authorization: "试拍已具备决策证据；确认正式生产或先修复试拍。",
  production_running: "查看逐镜头进度；失败时只处理受影响的局部。",
  repair_proposed: "比较修复范围、复用产物和预期，选择一个定向方案。",
  awaiting_repair_authorization: "确认局部修复范围后，系统才会发起新媒体请求。",
