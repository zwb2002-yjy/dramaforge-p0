  ...
  return (
    <section className="panel provider-config" data-testid="provider-config">
      ...
      <p className="provider-credential-status">
        密钥：
        {connections.isPending || connectionLoadError
          ? "状态未知"
          ...
          <div className="provider-grid">
            <div>
              ...
              >
                ...
                {paidProbe && (
                  <Field className="director-rights-confirm">
                    <Checkbox
                      type="checkbox"
            ...
            <div>
              ...
              <div className="toolbar">
                <Select
                  ...
                  disabled={
                    bindingMutation.isPending || !imageModels.length || Boolean(imageBinding)
                  }
                >
                ...
                <Select
                  ...
                  disabled={
                    bindingMutation.isPending || !videoModels.length || Boolean(videoBinding)
                  }
                >
