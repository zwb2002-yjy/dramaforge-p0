...
Read the single head from the candidate itself (`alembic heads`) instead of
pinning a revision number in this runbook: the current head is recorded in
[`../architecture/DATA_MODEL_INVENTORY.md`](../architecture/DATA_MODEL_INVENTORY.md).
