...
| 字段 | 当前事实 |
|---|---|
| 运行候选 | `8e3c30738cbc57c15afdf6c604b7879465f53133` (`dev`) |
| 当前候选 | `8e3c307`；运行中的 API、Dispatcher、两个 Worker 与 Frontend 同源，数据库 head `20260820_0029`；PostgreSQL、Redis、MinIO、LiteLLM 与数据卷未重建 |
| 自动化基线 | 当前候选后端全量 `660 passed / 16 skipped`、前端 `57 passed`、Chromium `11/11`、typecheck/build、Ruff/mypy 通过；同源 Docker Compose 栈健康 |
