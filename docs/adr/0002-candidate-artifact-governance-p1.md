...
**决策范围：DramaForge P0 边界、个人创作者 P1.1 候选产物治理、后续故事板/资产库/导演台/编辑器关系**
...
- 建立 P1.1 正式阶段合同，并同步 ADR、迁移、ORM、Pydantic/OpenAPI、测试夹具和验收用例；`01`–`06` 保留为 P0 冻结基线，必要演进通过版本化后继合同表达。
...
- P1.1 及当前个人创作者 P1 路线不引入成员、角色、邀请、共享或空间转让。未来多人协作必须先单独批准产品范围和授权模型，不能复活已移除的组织兼容层。
