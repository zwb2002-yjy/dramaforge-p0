...
- Status: IN_PROGRESS（G0–G6 COMPLETE；G7 真实 Provider Golden COMPLETE，Release Gate 待最终全绿）
...
| G8 Current-HEAD Release Gate 与 source/image/evidence 绑定 | task-contracts/V1-G8-RELEASE-GATE-20260903.md | IN PROGRESS |
